package com.fomopay.demo.linechart.touch
...
class ScrubGestureDetector(
    ...
    private inner class scaleListener() :
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            val view = weakReference?.get() ?: return false

            scaleFactor *= detector.scaleFactor
            scaleFactor = scaleFactor.coerceIn(0.1f, 3.0f) // Limit the scale factor
     ...
     */
    private fun isOutsideTouchSlop(
        startX: Float,
        endX: Float,
        startY: Float,
        endY: Float
